...
<head>
    ...
    <title>ECL Cold Store Blog</title>
...
<body style="font-family: 'DM Sans';/*margin-left: auto;*//*margin-right: auto;*/">
    ...
    <section style="padding-left: 60px;margin-bottom: 50px;">
        ...
        <div class="title-banner">
            ...
            <div style="display: flex;gap: 55px;padding-right: 60px;">
                <div class="swiper-button-prev1 swiper-button-prev14"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-128 0 512 512" width="1em" height="1em" fill="currentColor" style="color: #1b1c1c;font-size: 25px;">
                ...
                <div class="swiper-button-next1 swiper-button-next14"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-128 0 512 512" width="1em" height="1em" fill="currentColor" style="color: #1b1c1c;font-size: 25px;">
                        <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                        <path d="M64 448c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L178.8 256L41.38 118.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160c12.5 12.5 12.5 32.75 0 45.25l-160 160C80.38 444.9 72.19 448 64 448z"></path>
                    </svg></div>
            </div>
        </div>
        <div class="swiper mySlider-vid1" style="margin-top: 22px;">
    ...
    <section style="padding: 20px;">
        <div class="title-banner" style="padding-left: 40px;padding-right: 40px;">
            <h4 style="font-family: 'Anton';">Blogs</h4><select>
                <option value="12" selected="">Filter</option>
