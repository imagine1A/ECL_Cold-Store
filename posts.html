...
<body style="font-family: Outfit, sans-serif;">
        ...
        <div class="container-fluid"><a class="navbar-brand nav-logo" href="#"><img src="assets/img/logo.png" width="128" height="31"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="index.html#products">Our Products</a></li>
                    <li class="nav-item"><a class="nav-link active" href="blog.html">Blogs</a></li>
                    <li class="nav-item"><a class="nav-link" href="index.html#contact_us">Contact Us</a></li>
                </ul>
    ...
    <div class="body-body">
        <div style="margin-bottom: 28px;">
            ...
            <h2 style="font-family: Anton, sans-serif;">How to cook meat Properly</h2>
            <h6 style="font-family: Anton, sans-serif;">Jun 5, 2023</h6>
        </div><img src="assets/img/de985e3609b4f61c80bccedf04f997ad.jpg" style="width: 100%;height: 431px;object-fit: cover;object-position: center;border-radius: 24px;margin-bottom: 36px;">
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque dapibus felis et libero scelerisque, sed aliquet nulla tincidunt. Quisque lorem nisl, semper vitae mattis nec, vestibulum nec risus. Sed ut volutpat tortor, ut sodales diam. Integer at tristique turpis. Integer orci leo, fringilla ac aliquet vitae, condimentum non lorem. Duis velit ex, aliquam vel pellentesque et, dictum vitae mauris. Vestibulum commodo luctus tortor eu ultrices. Fusce commodo enim non eros consectetur maximus. Donec venenatis dolor ut vestibulum fermentum. Aliquam malesuada sit amet nulla id imperdiet. Suspendisse maximus purus et ligula maximus, a luctus ante fringilla.<br><br><span style="font-size: 21px;font-weight: bold;">Tender</span><br>In vitae velit risus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Phasellus tincidunt venenatis mi quis congue. Cras eu leo nisi. Ut ornare nisi eget sapien dapibus, eu ornare dolor egestas. Donec venenatis neque lacus, nec mollis odio fermentum a. Maecenas at elit sed diam elementum varius mollis vel arcu. Praesent ornare nisl mi, et posuere purus viverra sed. Sed a lacus nec lorem tincidunt condimentum. Nulla eu tellus pulvinar, tristique metus a, sodales nibh. Ut magna nisi, laoreet id lacus non, cursus bibendum tortor. Sed pretium elit erat. In non pretium null</p><img src="assets/img/1a89b9589b095bd52a0c06cc6f6ebe0f.jpg" style="width: 100%;height: 431px;object-fit: cover;object-position: center;border-radius: 24px;margin-bottom: 36px;">
        <p>In vitae velit risus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Phasellus tincidunt venenatis mi quis congue. Cras eu leo nisi. Ut ornare nisi eget sapien dapibus, eu ornare dolor egestas. Donec venenatis neque lacus, nec mollis odio&nbsp;</p>
        <div style="display: flex;gap: 14px;justify-content: center;align-items: center;flex-wrap: wrap;">
            <p style="margin: 0px;color: #0D0D0D;">Share Article :</p><button class="btn btn-primary" type="button" style="background: #F0F0F0;color: #0D0D0D;border-style: none;">Facebook</button><button class="btn btn-primary" type="button" style="background: #F0F0F0;color: #0D0D0D;border-style: none;">Instagram</button><button class="btn btn-primary" type="button" style="background: #F0F0F0;color: #0D0D0D;border-style: none;">Twitter</button>
        </div>
    </div>
